            ...
            <div class="col-md-8">
               ...
               <?php if (isset($_GET['p_id'])) {
                   ...
                   $update_statement = mysqli_prepare(
                       $connection,
                       'UPDATE posts SET post_views_count = post_views_count + 1 WHERE post_id = ?'
                   );
                   ...
                   if (
                       ...
                       $stmt1 = mysqli_prepare(
                           $connection,
                           'SELECT post_title, post_author, post_date, post_image, post_content FROM posts WHERE post_id = ?'
                       );
                   } else {
                       $stmt2 = mysqli_prepare(
                           $connection,
                           'SELECT post_title, post_author, post_date, post_image, post_content FROM posts WHERE post_id = ? AND post_status = ? '
                       );
